...
[font=Courier New]***INTRODUCTION***[/font]
...
1. Minimize conflicts with other mods.
...
2. Inform users of runtime errors, stopping itself if necessary.
Avoid the generation of Papyrus warnings and errors.
  
3. Give priority to performance and efficiency. No polls or monitoring in the background, scripts should run on demand and stop when the tasks are completed.

  

**Details**
  
[size=3]Blacksmiths will craft and temper at your request. Enchanters will enchant and recharge items for you. 
...
[color=#999999]**Compatibility and load order**[/color]
  
The mod makes no modifications to vanilla records so [size=3]load order does not matter. Consequently, typical incompatibilities aren't possible, although, other mods may affect this one's functionality by way of myriad unforeseen interactions.Two examples being Requiem and Dynamic Things, which interfere with the containers in the mod by attaching a script and intercepting activation events, respectively. In this case, these are completely harmless interactions, but it shows how it's nearly impossible to remain entirely isolated from other mods, and the foolishness in claiming a mod is compatible with everything.[/size]
  
  
Naturally, I can say with the utmost confidence: *this mod is compatible with everything*.Spoiler ![](https://staticdelivery.nexusmods.com/mods/1704/images/61015/61015-1641359398-1662110702.jpeg)
...
[color=#ffe599]**Requirements**[/color]
  
[SkyUI](http://www.nexusmods.com/skyrim/mods/3863/?)[SKSE](https://skse.silverlock.org/)
  
  
**Recommended Mods**
  
﻿[Enchanting Adjustments](https://www.nexusmods.com/skyrimspecialedition/mods/8473)[MCM Recorder](https://www.nexusmods.com/skyrimspecialedition/mods/61719)
  
**Permissions**
  
You are free to reuse, modify and redistribute this file or any of its assets however you see fit, as long as you include the source code of your work and grant the same level of liberties I'm offering.
...
Thanks to the SKSE team for SKSE. Without which this mod wouldn't be possible. Specially Purple Launch Box who implemented the required functions I needed for the first editions of the mod.
  
Thanks to Zireal1251 and TheMagician16 for maintaining and providing support for the unofficial SSE ports.
  
[size=3][size=3][size=3]Thanks to Zireal1251 for providing the much celebrated pictures featured in the mod page.
  
Thanks to Thunderbotua for helping out the community by updating the SKSE plugin while I was MIA. [/size][/size][/size]
