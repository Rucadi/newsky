...
Vigilant** (choose 'Vigilant Version')
...
**Atlas Map Markers SE - Updated with MCM** (the version by kryptopyr) 
  
Moves and renames the map marker for this location.
  
  
**Farmhouse Chimneys SE**Adds a chimney to the farmhouse.
...
**Unique Northern Vanilla Farmhouses**Changes the farmhouse to Unique Northern Vanilla Farmhouses via a config file for Base Object Swapper.
...
**Northern Roads Patch -[Available here](https://www.nexusmods.com/skyrimspecialedition/mods/77893?tab=logs)﻿**
...
![](https://imgur.com/HCdmK3W.png)﻿[font=Arial][/font]
