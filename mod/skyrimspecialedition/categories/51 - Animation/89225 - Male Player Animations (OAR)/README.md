...
- Mod Page: https://www.nexusmods.com/skyrimspecialedition/mods/89225


Male Player Animations OAR mod adds plug and play pack of 12 new idle animations to bring closer to life character with male skeleton. Each animation is 50 seconds long to feel least repetitive and more interesting comparing to short ones you may be using.
...
Add main mod archive to your mod manager and follow it's standard installation process.
  
If you use [EVG Conditional Idles](https://www.nexusmods.com/skyrimspecialedition/mods/34006), you may download optional patch archive and add it there as well, place after original EVG Conditional Idles mod. Don't forget to make new files active :)
  
  
You can download empty folders to add other idles on top of animations from this mod, read how in customization section.
...
Installing [No Heavy Muscular Walk And Idle for SSE](https://www.nexusmods.com/skyrimspecialedition/mods/59597) animation offset replacer will change how animations of this mod look on male characters. Most of them will look OK, but animations with hands folded might be off. If those animations are unsightly, just delete folders containing them. Or disable [No Heavy Muscular Walk And Idle for SSE](https://www.nexusmods.com/skyrimspecialedition/mods/59597), you can do it at any moment.
...
You can add more player idle animations from other authors on top of my pack. Download optional archive with 10 folders to add 10 idles or less. Start from folder with lower number. Open "male" folder, add there new idle and make it name "mt\_idle.hkx". Random() function value in \_condition.txt is low to provide mathematically accurate equal chance to play each animation including including mine. If you doubt my logic, here is a mod to help understand how DAR calculates it - [Dar Random() Calculator](https://www.nexusmods.com/skyrimspecialedition/mods/59838).
  
  
If you don't like some animation, see list below to find where it is to delete. Also you can use DAR Explorer app to play and preview animations in active DAR folders. Then just leave others you want to have, no need to correct conditions.
...
400212 -- hands locked infront player idle
  
400211 -- hands tightly folded player idle
  
400210 -- hands folded one over player idle
  
400209 -- hands on hips player idle
  
400208 -- warm up player idle
  
400207 -- sway bees away player idle
  
400206 -- scratch head player idle
  
400205 -- sleeve check and shoulder rub player idle
  
400204 -- check nails and arm player idle
  
400203 -- good mood player idle
  
400202 -- weight shift w breathing player idle
  
400201 -- alternative player idle
  
400200 -- optional mt\_idle replacer for player only
...
If you don't care about idles being conditional and just want to have rotation of animations for you character, you can use batch process from [Dynamic Random Female Idles V2](https://www.nexusmods.com/skyrimspecialedition/mods/39431). You may need to change folders "female" to "male" manually, but everything else is the same.
...
Added animations from female rig to male rig and extensively corrected anatomical differences.
