...
- Mod Page: https://www.nexusmods.com/skyrimspecialedition/mods/91438
...
* **Hair mods with intense physics** can freeze facial animations — use *showracemenu* to reset
**Face-covering helmets** may disable expressions  
  
* **Disable sounds/notifications:** Available in MCM
Logs available at:  
  
*Documents\My Games\Skyrim Special Edition\Logs\Script\User\ConditionalExpressionsExtended.0.log* (enable Papyrus logging)
