...
Some animations were already added to children with my other mods [NPC Animation Remix](https://www.nexusmods.com/skyrimspecialedition/mods/63471), [Gesture Animation Remix](https://www.nexusmods.com/skyrimspecialedition/mods/64420) and [Immersive folded hands](https://www.nexusmods.com/skyrimspecialedition/mods/62849), so I made this mod with consideration of it. It`s like three layer cake and this mod adds frosting on top of it. Also I chose folder numbers in such a way what conditional idles from other mods will work for children. 
...
* This mod works without Nemesis or FNIS. [Open Animation Replacer](https://www.nexusmods.com/skyrimspecialedition/mods/92109) needed only - both SE and AE versions of OAR will be able to play this animations
...
At any time in your playthrough you can delete folders or animations from it or modify OAR conditions. Use provided folder descriptions as a reference. . To play .hkx animations use [hkxPoser](http://www.nexusmods.com/skyrimspecialedition/mods/11783) or OAR preview function
...
Mod Organizer 2 users - [color=#d9ead3]rename mod folder in your mod manager to "LCA OAR" and it will fix this
  
Other mod manager users - extract the zip file and rename the "Lively Children Animations (OAR)" named folder to "Data", repack and install[/color][/i]
...
[Cuyima Interesting NPCs SE](https://www.nexusmods.com/skyrimspecialedition/mods/27330) with Vanilla Hair + [Interesting NPCs Visual Overhaul](https://www.nexusmods.com/skyrimspecialedition/mods/40046) (replaces only females) + [Tragedian's Interesting NPCs - 3DNPC Followers Reimagined](https://www.nexusmods.com/skyrimspecialedition/mods/61669) on top of that
...
*Other mod recommendations from me you can find at the bottom of [NPC Animation Remix (OAR)](https://www.nexusmods.com/skyrimspecialedition/mods/63471) page*