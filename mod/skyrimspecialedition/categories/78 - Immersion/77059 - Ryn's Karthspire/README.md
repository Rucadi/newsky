...
- Mod Page: https://www.nexusmods.com/skyrimspecialedition/mods/77059
...
***One of my most in-depth overhauls yet.***
  
 A pivotal location in the main story of Skyrim, Karthspire is meant to be difficult, and exciting.
  
Generally speaking, it is only sometimes more difficult than the average dungeon exterior. The enemies there in vanilla are nearly all defined as "aggro-range" enemies. Meaning just about every single one of them will watch you kill their buddies from 30 feet away, until you fight them next. This leads to weird situations where the player has little trouble defeating the already over-average amount of enemies in the area, while those enemies are stopped in totally random spots, seemingly waiting their turn to die.
  
I saw what Bethesda was trying to make when I really thought about why the enemies were chosen to be this way, and I expanded on it ***BIG TIME.***
  
Still, about half of the enemies will hold their positions. But now, they hold their positions in much more tactically-advantageous areas. Melee forsworn will be "aggro-range" enemies who will be waiting for you to cross into their threshold, while archers in other high-up areas will pelt you with arrows while you make your way across the many bridges, and through the lower alleyways.
  
  
Hagraven Matron
  
The Hagraven who normally spawns in this location has been replaced with another, unique Hagraven.
  
Now a uniquely named boss (who will hold a unique weapon in the short future), The Hagraven Matron is in terms of stats, is fairly buffed from its vanilla counterparts. It is not a tank by any means, although it does have a buff in HP, and some new defensive spells.
  
Instead, its newly added perks allow it to hit *much harder* than its vanilla underlings.
  
  
  
Structural Changes
  
Karthspire offered a fantastic opportunity to use some of the least-used assets in the entire game. The building blocks of Sky Haven Temple.
  
Karthspire is now an extremely unique location with its own personality that sets it apart from every single other location I have updated, boasting not only a very distinct architecture, but a unique design in how you navigate the location. Skyrim lacks verticality in its dungeons and worldspaces, and it lacks depth. Ryn's Karthspire feels both true-to-vanilla, and so very excitingly new in this way. I feel this is some of my best to-date examples of what Vanilla+ means in my project.
  
  
Performance
  
Karthspire received not only an overhaul of its original footprint, but a huge increase in the size of said footprint. The location is roughly 3x the detail of the original location, and 2x the size. With increases like this, it's reasonable to expect a performance hit. 
  
However, given the design of the location now with its vertical nature, occlusion cubes and planes were able to be used extensively.
  
In vanilla testing, not once did I drop below***58.5 FPS*.** In modded testing, frames stayed more stable while in the location, than areas surrounding it. Typically in my modded performance-test-profile, 45-55 FPS can be expected in the surrounding area. Inside of Ryn's Karthspire, I averaged *53 FPS.* Remember that you can expect different outcomes based on your setup.
