...
- Mod Page: https://www.nexusmods.com/skyrimspecialedition/mods/79739
...
Ryn's Mistwatch Folly takes on creative freedom, as the NEW interior dungeon has little lore-based inspiration.
  
The original exterior location is no more than a barely recognizable platform with a few skeletons.. sleeping.
  
The exterior has grown to be an extension of the existing fort, Mistwatch.
  
Mistwatch itself has seen some upgrades. Including small fixes, new occlusion planes and boxes, and small rearrangements.
  
The prior-existing skeletons inspired the still-destroyed-but-expanded-upon, to be an undead-infested lair, held by a powerful Lich and its large amounts of skeleton soldiers.
  
By the Lich's side, a large, much stronger skeleton defends its master vigorously.
...
Please take a moment to read the letter I've written to the community in the comment section.
  
  
The original mod I planned to release was far exceeding the capabilities of ESLification.
  
Because of this, I had to reduce size of the dungeon, and details of the existing spaces.
  
Because of these limitations, Mistwatch itself did not receive the same level of upgrades that many of my other locational overhauls of received. This is mostly about the exterior of Mistwatch Folly and the new interior cell that comes with it. To keep patch compatibility as simple as possible, I will not be releasing a secondary file to continue the expansion of Mistwatch proper. Thank you.
