...
Check out the official [documentation and guides](https://github.com/ousnius/BodySlide-and-Outfit-Studio/wiki/Guides-and-Documentation) here on the [Wiki](https://github.com/ousnius/BodySlide-and-Outfit-Studio/wiki)
...
![](http://i.imgur.com/xXsc576.png)
  
Here's a [video tutorial by Gopher](https://www.youtube.com/watch?v=Wkwtgp3x25s) on how to install body mods and BodySlide with the Nexus Mod Manager.
...
1. Download and open the archive with 7Zip, and extract the 'CalienteTools' folder to Steam/SteamApps/Common/Skyrim Special Edition/Data.
After you're done, the executable "BodySlide x64.exe" for you to launch can be found in: "Steam/SteamApps/Common/Skyrim Special Edition/Data/CalienteTools/BodySlide"
...
1. Download and install the archive to Vortex like you would do with any other mod and enable it.
...
In the "Target" field, choose the "BodySlide x64.exe" file from your game installation's real data folder, NOT the Vortex mods folder: "Steam/SteamApps/Common/Skyrim Special Edition/Data/CalienteTools/BodySlide".
  
3. Install any BodySlide addons such as body mods and outfits to Vortex as well.
[GIF of the Vortex installation process](https://staticdelivery.nexusmods.com/mods/1704/images/201/201-1537370120-1864925415.gif)
...
In MO2, go to the Data tab on the right, locate the BodySlide x64.exe in the CalienteTools/BodySlide folder, right click it, and add it as an executable. You can then launch it through MO2.
  
2. When BodySlide is open, click on the Settings button and ensure the Game Data Path points to your actual game data folder, e.g. "C:/Games/Steam/SteamApps/Common/Skyrim Special Edition/Data/".
Install any BodySlide addons such as body mods and outfits to MO as well.
  
3. After BatchBuilding, the files will appear in your Overwrites folder. [You will need to create a new mod folder, for example 'BodySlide Output', move the files from Overwrites into this folder, and then enable it.](https://www.afkmods.com/index.php?/topic/8960-slessefo4-bodyslide-and-mo2-what-to-do-with-bodyslide-output-files/)﻿
...
* Make sure you've installed the body mod for the matching game (download CBBE SE for Skyrim SE/AE, not CBBE LE).
If using mod managers such as Vortex and MO, first confirm that other mods are generally working in-game.
  
* If using mod managers such as Vortex and MO, set up your BodySlide shortcut to point to the real game folder (Steam folder) instead of the Vortex/MO specific mods folders.
...
![](http://i.imgur.com/qvep2he.png)
  

  
* [Caliente's Beautiful Bodies Enhancer -CBBE-](https://www.nexusmods.com/skyrimspecialedition/mods/198)
[Touched by Dibella](https://www.nexusmods.com/skyrimspecialedition/mods/20024)
  
* [CBBE SMP](https://www.nexusmods.com/skyrimspecialedition/mods/29023)
[CBBE 3BA](https://www.nexusmods.com/skyrimspecialedition/mods/30174)
  
* [BHUNP](https://www.nexusmods.com/skyrimspecialedition/mods/31126)
[Highly Improved Male Body Overhaul - HIMBO-](https://www.nexusmods.com/skyrimspecialedition/mods/46311)
  
* [HIMBO Lite](https://www.nexusmods.com/skyrimspecialedition/mods/63107)
[CBBE SFW](https://www.nexusmods.com/skyrimspecialedition/mods/74257)
  

  
  
![](http://i.imgur.com/lrW7B26.png)
...
A: Make your changes to the sliders, and then CTRL+Click the 'Build' button. The femalebody\_0.nif and femalebody\_1.nif will then appear in the BodySlide folder. You will need to copy these to your Skyrim/Data/meshes/actors/character/character assets/ directory, and allow any overwrites. You also may need to copy these elsewhere if you use a standalone race/follower mod, so consult that mod's description/readme. Note that if you use MO2, BodySlide will generally place the built meshes into your overwrites folder. You need to turn that into its own mod in MO2 each time you do a Build/BatchBuild.
...
A: Make sure you have installed a compatible body mod, and have set up BodySlide according to the installation instructions. You may need to launch the game without SKSE64 at least once to ensure the registry is set. If using Vortex or MO2, ensure that the Game Data Path under BodySlide's Settings points to your \...\Skyrim Special Edition\Data\ folder.
...
A: You need to make sure the body you have installed is actually BodySlide-compatible. After that, ensure you have followed the installation instructions exactly, especially about making sure the Game Data Path is set correctly, and that if you use Vortex or MO2, that you are launching BodySlide through those mod managers.
  
  
Q14:There's ~~scary red~~ shiny gold text at the bottom of BodySlide. Wat do?
...
- Turkish translation by predaturk
