# dm's Spell Learning Overhaul
- Author: DanMaklen
- Game: skyrimspecialedition
- Mod Page: https://www.nexusmods.com/skyrimspecialedition/mods/49003
...
```
Note: This is mostly intended for my personal use. I am not sure when or if I will update it.
```
...
* A chance to lose the the spell tome after studying.[list]
...
* The exhaustion parameter scales with:[list]
...
Your focus is affected by where you study:[list]
...
**Source**[Github](https://github.com/DanMaklen/dmSpellLearning)