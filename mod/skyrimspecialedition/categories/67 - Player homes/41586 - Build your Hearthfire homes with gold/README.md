...
Pick one of the four main files, depending if you are using the Unofficial Skyrim Special Edition Patch or sticking with vanilla Skyrim. The other choice is if you want double the price of building. There's also an optional file for the Farming Creation Club content (Goldenhills Plantation), so you can build stuff with gold in there as well. All files are flagged ESL.
