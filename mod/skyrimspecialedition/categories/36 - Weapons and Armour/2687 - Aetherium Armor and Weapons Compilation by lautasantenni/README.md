...
*OK, I (InsaneGizzardsauce) have returned to Skyrim after being in Starfield for a while. I'll respond to level one questions, but keep in mind that this mod is still static. There will not be any changes to this mod.*
...
* [size=2][b][u]Do [b]not** add or remove this -- or any-- mod mid-playthrough. Skyrim saves bake in FormIDs and scripts at creation; changing them mid-run will corrupt your world. Texture replacers are the *only* safe mid-additions.[/b]
...
**Reported Problems by Users -- IF YOU USE PERK OVERHAULS, THIS MEANS*YOU!***It can't be overstated. Some mods don't play well with others.
  

  
* [size=2]**[Adamant - A Perk Overhaul](https://www.nexusmods.com/skyrimspecialedition/mods/30191?tab=description)﻿ --** even with smithing at 100 and all perks earned, you will be unable to craft the enchanted armor and bolt rifle.
  
[Complete Crafting Overhaul Remastered](https://www.nexusmods.com/skyrimspecialedition/mods/28608)﻿ -- "There is a patch available at kryptopyr's Patch Hub, which LOOT will recommend you get if you have both this mod and CCOR installed. With that patch installed, the requirement to craft aetherium equipment is Orcish Smithing (and of course having those recipes visible with CCOR's filters). This is IN ADDITION TO having Arcane Blacksmith and having completed Unfathomable Depths as per the base mod. If you use [Ordinator](https://www.nexusmods.com/skyrimspecialedition/mods/1137)﻿ in addition to CCOR, the Orcish Smithing perk corresponds to picking Expert Smithing in Ordinator (level 50 perk) and choosing Orcish (or equivalent if you're using some other mod which further changes Ordinator perks). "
  
- [Ordinator - Perks of Skyrim](https://www.nexusmods.com/skyrimspecialedition/mods/1137)﻿ -- "Commenting for people with Ordinator Mod I just tested it myself with the Ordinator Mod, Meric Smithing on the left (Choose Dwarven) and Arcane Blacksmith."
...
* [size=2]On 9/11/2021
Vulthursil posted [Aetherium Armor and Weapons Compilation Cleaned and Enhanced Textures](https://www.nexusmods.com/skyrimspecialedition/mods/55438/?tab=description)﻿. You'll still need this mod as a hard requirement.
  
  
**FAQ:** 
  
  
**Q:** Where do I forge the weapons, armor, and ingots?
...
**A:** You need to *first* complete the [Unfathomable Depths](https://elderscrolls.fandom.com/wiki/Unfathomable_Depths) quest. **Also** you need to have the "arcane blacksmith" smithing perk.
...
**Q:** I can't start the [Unfathomable Depths](https://elderscrolls.fandom.com/wiki/Unfathomable_Depths) quest!
...
**A:** Please don't. No. Skyrim’s save system cannot adapt to new plugins once a world is created. Doing so will break quests, recipes, and references. Start a new game.
  
  
[/size]**Q:** "Do I **really** need to have finished 'Unfathomable Depths'?"
...
* [size=2]Absorbs incoming spells 10% chance
...
* The original mod author (Lautasantenni) granted Darkjesusmn permission to port Aetherium Armor and Weapons Compilation (<https://www.nexusmods.com/skyrim/mods/23530>)from Skyrim LE to SE.
The original description and notes from the Skyrim LE Aetherium Armor and Weapons Compilation can be found at the Skyrim LE link (<https://www.nexusmods.com/skyrim/mods/23530>).
  

**Mod Update History** *– descending order*
  
**February 24, 2021**InsaneGizzardSauce added as a mod contributor and posted an update with the following improvements:
...
The following notes are copied from the original mod on Skryim LE (<https://www.nexusmods.com/skyrim/mods/23530>) and are kept for historical purposes.
...
1. Aetherium Armor & Weapons adds the main things as follows: "Aetherium Ore" chunks, that can be found in dwemer storehouses or storehouse like areas. You can also find them in Blackreach, inside a few buildings and at Raldbthar deep market. Also, the new version will include more of the ore.
...
2. You will have to do the crafting of all aetherial items in the aetherial forge that you will find in one of the Dawnguard's side quests, which can be started by reading the book called "Aetherium Wars". Also, the forge is the only place where you can smelt down the aetherium ore into ingots.
