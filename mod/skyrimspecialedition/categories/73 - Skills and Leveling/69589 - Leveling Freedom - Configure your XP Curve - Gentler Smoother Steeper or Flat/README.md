...
- Mod Page: https://www.nexusmods.com/skyrimspecialedition/mods/69589
...
(We agree, that title is a bit much. There's not even a real Limousine.)
  
  
**What does this do?**
  
  
This mod gives you control over the shape of the leveling curve in the game. You can adjust how quickly levels come at first, and how much more they cost as you level up - if more at all. Configurations are also saved with you character, so you can have multiple different characters at once.
...
[Required XP Per Level](https://www.desmos.com/calculator/p36vukcimy)[Total Required XP](https://www.desmos.com/calculator/veszwpjroz)
...
No "boot & pray", information and confirmation in-game, in realtime.
...
This mod is compatible with everything... except for [Skyrim Configuration Menu](https://www.nexusmods.com/skyrimspecialedition/mods/85707), which forces all its values and is not recommended for use.
  
  
[Experience](https://www.nexusmods.com/skyrimspecialedition/mods/17751) is recommended, and in fact this mod was made specifically with it in mind. The recommended preset remains the same whether you are using it or not.
...
This mod is inspired by [Evildavo's](https://www.nexusmods.com/skyrim/users/11075813) [Gentler Leveling Curve](https://www.nexusmods.com/skyrim/mods/54759/) mod for Legendary Edition. The existence of that mod and other for SLE is also the reason I will not make a version of this mod for SLE. I "stole" some of the numbers from his presets since they made sense.
  
  

**No part of this mod may be distributed on the Bethesda modding platform.**