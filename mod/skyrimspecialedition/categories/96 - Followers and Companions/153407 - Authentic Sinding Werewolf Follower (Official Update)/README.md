# Authentic Sinding Werewolf Follower (Official Update)
- Author: PajasKatt
- Game: skyrimspecialedition
- Mod Page: https://www.nexusmods.com/skyrimspecialedition/mods/153407


**Shameless advert for those who play Oblivion Remastered;**
  
I actually made a mod which brings Sinding, Serana and Erandur as custom followers in Cyrodiil!
  
<https://www.nexusmods.com/oblivionremastered/mods/5108>
  
  
-----
  
  
This is the continuation of [Authentic Sinding Follower](https://www.nexusmods.com/skyrimspecialedition/mods/33517)
  
  
Disclaimer: While I technically wanted to remain discrete about my past identities, I couldn't just leave this mod alone for good, I felt the urge to work on some major improvements and try to resolve some issues. I'm gonna start off leaving the comments disabled for a little while so people don't immediately bombard me with feedback. If you have any important questions, you'll know how to contact me and I will try my best to answer, but I will also appreciate if y'all refrain from dogpiling me.
  
  
I highly encourage people to translate this mod as well as creating compatibility patches, just don't expect me to devote my precious time to do all the work for you.
  
  
[Check out the unofficial werewolf invisibility patch hub I've just released if you're using certain NPC replacers!](https://www.nexusmods.com/skyrimspecialedition/mods/153618)
  
  
-----
  
  
**Some important troubleshooting!!**
  

  
* This mod needs to be loaded AFTER any other mod which changes the DA05Sinding NPC such as Diverse Werewolves Collection, or else he might show up naked and/or headless... If you're uncertain which plugins make changes to him, you can always check in xEdit. Other than that, should be fully compatible with mods which changes the appearance of DA05SindingHuman.

  
* I also play with Nether's Follower Framework and Sinding should certainly work fine with it since he uses the vanilla follower framework which NFF also overhauls. Just be sure to ignore the werewolf transformations which NFF handles.

Original mod description (spoilered 'cuz it might be TL;DR at this point):
...
Be sure to check out my [update to Were-Circle](https://www.nexusmods.com/skyrimspecialedition/mods/153414) as well! It features transformation mechanics similar to this mod, except it's for the three Companions.
  
  
**Anyway, here are the changes I've made in this update:**![](https://staticdelivery.nexusmods.com/mods/1704/images/153407/153407-1750874367-1416705106.gif)
  
  

  
* I have restored Sinding's secondary line of dialogue for when you tell him that the last of the hunters are dead, which was apparently cut from the vanilla game.
I have regenerated/revoiced a whole bunch of existing dialogue from the original mod in ElevenLabs, based on [Unique Voice for Sinding](https://www.nexusmods.com/skyrimspecialedition/mods/133875), just to gain more emotion.
  
* You now have to manually talk to Mathies and pick the "I have brought someone special..." dialogue in order to initiate the confrontation scene. I think lots of people had trouble getting the scene to play due to how how it was originally supposed to trigger through a silent idle dialogue and then Mathies' current AI package probably didn't have idle chatter enabled.
The patch found at [Werewolf Revert Effect and Animation](https://www.nexusmods.com/skyrimspecialedition/mods/76472) is now considered obsolete and is already implemented in this update.﻿
  

  
* **The configuration menu now features a handful of new options;**
You can add (or remove) Sinding to the Companions Circle faction ﻿to prevent him from being affected by the player's Howl of Fear.
  
* You can enable so that Sinding immediately gets added to the potential follower faction when you tell him that the hunters are dead, which will make more sense with the dialogue line which I restored. Should you install this mod on a save where you have already beaten the Daedric quest, you may also enable this option as a "cheat" just to bypass the speech check if you're not already a werewolf.
You can set the werewolf race which Sinding will transform into, between Standalone (default), Vanilla but also [Diverse](https://www.nexusmods.com/skyrimspecialedition/mods/7009)﻿ and [Unique](https://www.nexusmods.com/skyrimspecialedition/mods/145578) if you have them installed. The way I scripted these powers to be "cast" should make the mod safe to install on an existing save. You can technically set the werewolf skin in the MCM at any time while Sinding is human, that also includes before you talk to him in prison.
...
* ~~As soon as my ElevenLabs subscription gets renewed, I may eventually recreate more of the existing dialogue, but I may also try to implement new dialogue scenes which my friend has written me manuscripts for in the past.~~

  
**Installation:**
  
Install the original mod first. You can manually download the archive, open up your mod-managing application (like Vortex or MO2), then drag-and-drop the archive into the program, prompt yes to overwrite and enable the plugin.