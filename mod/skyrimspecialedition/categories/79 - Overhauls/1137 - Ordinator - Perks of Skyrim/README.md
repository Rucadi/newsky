...
- Mod Page: https://www.nexusmods.com/skyrimspecialedition/mods/1137
...
Skyrim Legendary Edition version available [here](http://www.nexusmods.com/skyrim/mods/68425?)
  
25/12/2021 #12 most endorsed mod of all time! Thanks community! ♥
  
  
[font=bebas\_neuebook]Features
...
[font=bebas\_neuebook]Ordinator review on Youtube[/font]
  
  
 
  
  
[font=bebas\_neuebook]Full list of perks[/font]
  
  
[font=bebas\_neuebook]Alchemy
...
* **40 - Elemental Oil** - You may choose a power: "Fire Oil", "Frost Oil" or "Shock Oil". At will, create a pool of oil that lasts 20 seconds. It reacts violently when struck by a projectile or explosion, exploding and dealing damage equal to twice your Alchemy skill level.[/\*]
...
* **50 - Lab Skeever** - For 20 seconds after using any alchemy lab, beneficial potions you drink last 15 times longer and are 10% stronger.[/\*]
...
[font=bebas\_neuebook]Alteration
...
* **80 - Ritualist** - Able to cast two-handed ritual spells while moving, at 25% reduced effectiveness.[/\*]
...
[font=bebas\_neuebook]Conjuration
...
* **30 - Ravenous Dead** - Reanimated minions receive a brief burst of strength, dealing 200% extra attack damage for 20 seconds after being reanimated. The level cap of reanimation spells and effects is increased by 1% per level of Conjuration.[/\*]
...
* **50 - Undead Crown** - Restores 10 points of Health and Magicka per second to summoned or reanimated undead within 20 feet.[/\*]
...
* **60 - A Plague Upon Thee** - If a reanimated undead is destroyed within 20 seconds, the attacker is stricken with a Daedric disease that deals 15 damage per second for 20 seconds. Those who have this perk are immune.[/\*]
...
[font=bebas\_neuebook]Destruction
...
**30 - Static Field** - Shock spells that would leave their target above 85% Health deal enough additional damage to make up the difference.[/\*]
...
[font=bebas\_neuebook]Enchanting
...
**20 - Last Word (3)** - Scrolls are 50/100/150% more powerful or last 100/200/300% longer.[/\*]
...
[font=bebas\_neuebook]Heavy Armor
...
[font=bebas\_neuebook]Light Armor
...
[font=bebas\_neuebook]Lockpicking
...
[font=bebas\_neuebook]One-Handed
...
[font=bebas\_neuebook]Pickpocket
...
[font=bebas\_neuebook]Restoration
...
* **50 - Overflowing Cup** - Receiving a healing spell or effect when you are already at full Health overheals you, regenerating 2% Health per second for 30 seconds.[/\*]
**50 - Pilgrim** - Shrine blessings you receive are 1% stronger per level of Restoration.[/\*]
  
* **50 - Warrior's Flame** - In combat, the Warrior's Flame periodically touches a random target within 100 feet (including you). Friendly targets are blessed, restoring 15 points of Magicka and Stamina for 5 seconds. Hostile targets are cursed, draining the same amount instead.[/\*]
**60 - Ashes to Ashes** - Your Warrior's Flame carries the essence of death. Hostile undead cursed by Warrior's Flame take 20 points of damage per second.[/\*]
...
* **40 - Dynamic Entry** - Performing a silent roll increases your weapon damage by 50% and unarmed damage by 40 points for 3 seconds.[/\*]
...
* **80 - Partystarter** - When you gain invisibility, places a barrel of flammable booze at your location. When you lose invisibility, it explodes, dealing fire damage equal to twice your Sneak skill level and staggering targets. This effect has a 15 second cooldown and only activates in combat.[/\*]
...
[font=bebas\_neuebook]Two-Handed
...
* **50 - Breach the Wall** - Forwards power attacks with a greatsword that would leave the target above 70% Health deal enough additional damage to make up the difference.[/\*]
...
* **70 - Massacre** - In combat, swinging a two-handed weapon has 10% chance to increase attack speed by 100% for 5 seconds.[/\*]
...
[font=bebas\_neuebook]Other features[/font]
  
  
[font=bebas\_neuebook]Optional thief skills rebalance[/font]
...
[font=bebas\_neuebook]NPCs get Ordinator perks[/font]
...
[font=bebas\_neuebook]Recommended mods[/font]
...
My "full size" overhauls can be used interchangeably with my "V++" overhauls, which are more vanilla-plus and stay closer to vanilla Skyrim balancing, at the cost of some of the more crazy features. See [my profile page](https://www.nexusmods.com/skyrimspecialedition/users/3959191) for a full list.
  
  
[font=bebas\_neuebook]Compatibility[/font]
  
  
See [here](http://www.nexusmods.com/skyrimspecialedition/articles/22/?) for a list of (in)compatible mods.
...
**The perks Quick Shot and/or Hailstorm greatly reduce my attack speed:** Quick Shot is a vanilla Skyrim perk and Skyrim has a bug where it sometimes loses its attack speed bonus, reverting it from 1.30 to 0. This means any other attack speed bonus will increase the attack speed to a value above 0 but probably less than 1, so your attack speed decreases instead of increases. The fix consists of refunding your perk points and taking the perks again. Note that this bug (the ability condition bug, where conditional abilities get stuck in the on or off position) is prevalent in vanilla Skyrim as well and is not caused by Ordinator.[/\*]
  
* **The perks Ravage and/or Man O'War greatly reduces my attack speed:** Ravage (named Dual Flurry in vanilla) is a vanilla Skyrim perk and Skyrim has a bug where it sometimes loses its attack speed bonus, reverting it from 1.35 to 0. This means any other attack speed bonus will increase the attack speed to a value above 0 but probably less than 1, so your attack speed decreases instead of increases. The fix consists of refunding your perk points and taking the perks again. Note that this bug (the ability condition bug, where conditional abilities get stuck in the on or off position) is prevalent in vanilla Skyrim as well and is not caused by Ordinator. Alternatively, mods that merge multiple perk overhauls and rearrange the perk trees in the process may give you access to Man O'War without the prerequisite Ravage, which would result in a very similar outcome.[/\*]
**My perk worked and then suddenly it stopped working:** This is the ability condition bug as described in the previous FAQ item. Refund your perk points.[/\*]
...
**The perks Ranger, Quick Shot and Block Runner have no effect:** These are vanilla Skyrim perks with a peculiar bug. If you had those perks at any point during your playthrough, removing them does not remove the effect. Additionally, Ranger in particular has another bug where it has no effect if you take the perk while sneaking. Note that all of this also applies to the same perks in the vanilla game. See [the UESP page](http://www.uesp.net/wiki/Skyrim:Archery) for more information.[/\*]
  
* **Fistfights (brawls) immediately end or turn into a real fight:** The "**Brawl Bug**" is a common issue with many gameplay mods and hard to avoid due to the way Skyrim brawls are implemented. Ordinator comes with a copy of the Modern Brawl Bug Fix included to solve this issue. If it does not, you may have the outdated Brawl Bugs Patch in your load order after Ordinator (as a standalone mod or included with another mod such as Enhanced Blood Textures). Either remove it or add the [Modern Brawl Bug Fix](https://www.nexusmods.com/skyrimspecialedition/mods/1473) to the end of your load order.[/\*]
**Perk descriptions are truncated on 4:3 aspect ratio monitors:** This is a limitation of Skyrim. Use the [Extended UI](http://www.nexusmods.com/skyrim/mods/57873/?) mod.[/\*]
