...
This patch corrects the issue by replacing the ESP file. It was created by re-saving the original in the Creation Kit, so you can do that instead of using this mod. This is just here to save you time.
  
  
[TheLogan has created a German version of this patch.](https://www.nexusmods.com/skyrimspecialedition/mods/34111)
  
  
100% of the donation points go to Doctors without Borders.