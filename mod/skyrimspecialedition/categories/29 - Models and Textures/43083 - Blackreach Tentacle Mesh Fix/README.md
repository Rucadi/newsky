...
- Mod Page: https://www.nexusmods.com/skyrimspecialedition/mods/43083
...
* Changes UV map to reduce texture seams
Changes UV map to reduce texture pixelation
  
* Adds simple collision to mesh to prevent clipping through

**Credits**

  
* Fuzzles for requesting this mod

**Installation**

  
* Safe to install at anytime
...
* Will use Blackreach mushroom texture replacers