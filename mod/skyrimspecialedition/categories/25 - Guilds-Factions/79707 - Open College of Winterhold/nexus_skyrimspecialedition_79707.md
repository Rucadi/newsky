# Open College of Winterhold
- Author: lilebonymace
- Game: skyrimspecialedition
- Mod Page: https://www.nexusmods.com/skyrimspecialedition/mods/79707
**Introduction**
...
Provided more options for what robes Mirabelle Ervine gives to you. By default you always get Destruction robes like in vanilla, but in the MCM you can change it to robes with just magicka regen enchantment, no enchantment at all or an enchantment selected automatically based on the spell that you cast during the test or your highest skill.
  
  
﻿
  
(the badly spliced voice line was fixed since then)
...
* (Optional)[powerofthree's Papyrus Extender](https://www.nexusmods.com/skyrimspecialedition/mods/22854)
(Optional) [SkyUI](https://www.nexusmods.com/skyrimspecialedition/mods/12604)﻿ - for the MCM
...
* [Misc. College of Winterhold Tweaks](https://www.nexusmods.com/skyrimspecialedition/mods/22653)﻿ modules: Friendly Faralda, Mage-Light Maintenance, Governable Gatekeeper (other modules are compatible)
[Not So Fast - Mage Guild](https://www.nexusmods.com/skyrimspecialedition/mods/5686)﻿
  
* [Faction Exclusivity](https://www.nexusmods.com/skyrimspecialedition/mods/72369)﻿
[Git Gud - Trainers Have Standards](https://www.nexusmods.com/skyrimspecialedition/mods/51023)﻿
  
* [Skyrim True Master Trainers](https://www.nexusmods.com/skyrimspecialedition/mods/772?tab=description)﻿
[Trainer Dialogue Menu Missing (perhaps very dirty) Fix](https://www.nexusmods.com/skyrimspecialedition/mods/22214)﻿
...
* [Hit - Dialogue Scene Cooldowns](https://www.nexusmods.com/skyrimspecialedition/mods/84420)﻿

Compatible if placed after Open College.esp:
  

  
* [The College of Mages](https://www.nexusmods.com/skyrimspecialedition/mods/33750)﻿
...
[size=2][At Your Own Pace: College of Winterhold](https://www.nexusmods.com/skyrimspecialedition/mods/52704) (Open College must overwrite AYOP files. If you use both AYOP and Quest Expansion, there's a combined patch that needs to be placed after At Your Own Pace - College Quest Expansion Patch.esp)[/size]
...
* [BUVARP SE RE - Chronicles of the College](https://www.nexusmods.com/skyrimspecialedition/mods/101799?tab=posts)﻿
[Narrative Gameplay Consistent Dialogue Tweaks - Distance Checks](https://www.nexusmods.com/skyrimspecialedition/mods/64667)﻿
  
* [Obscure's College of Winterhold](https://www.nexusmods.com/skyrimspecialedition/mods/20514)﻿ (place the patch before OCW\_CellSettings.esp)
[Magical College of Winterhold](https://www.nexusmods.com/skyrimspecialedition/mods/1539)﻿ (place the patch before Magical College of Winterhold patches for lighting mods)
  
* [Juniper's College of Winterhold](https://www.nexusmods.com/skyrimspecialedition/mods/11915)﻿ (Open College must overwrite Juniper's College files)
[JK's College of Winterhold + Obscure College of Winterhold](https://www.nexusmods.com/skyrimspecialedition/mods/67820?tab=files)﻿ [size=2](includes the individual patches for JK and OCW. place the patch before OCW\_CellSettings.esp)[/size]
  
* [Ultimate College of Winterhold - an ICOW and OCW Patch](https://www.nexusmods.com/skyrimspecialedition/mods/44797)﻿ (includes the individual patches for ICOW and OCW. place the patch before OCW\_CellSettings.esp)

Third-party patches:
  

  
* [Immersive College of Winterhold](https://www.nexusmods.com/skyrimspecialedition/mods/79759)﻿
[JK's College of Winterhold](https://www.nexusmods.com/skyrimspecialedition/mods/79759)﻿
  
* [College Curriculum](https://www.nexusmods.com/skyrimspecialedition/mods/79929)﻿

Compatible:
  

  
* [Misc. College of Winterhold Tweaks](https://www.nexusmods.com/skyrimspecialedition/mods/22653) modules EXCEPT: Friendly Faralda, Mage-Light Maintenance, Governable Gatekeeper
[College of Winterhold Quest Start Fixes](https://www.nexusmods.com/skyrimspecialedition/mods/53817)
  
* [AI Overhaul Lite](https://www.nexusmods.com/skyrimspecialedition/mods/21654)
[Immersive Citizens](https://www.nexusmods.com/skyrimspecialedition/mods/173)﻿
  
* plugins from [Ultimate College of Winterhold - Definitive Edition](https://www.nexusmods.com/skyrimspecialedition/mods/118117)﻿
...
New trainers in the College: add their references (not base records) to CollegeTrainers formlist, the references must be persistent (have Persistent flag). If the trainer doesn't have the trainer dialogue before joining the College even with the "Train Without Joining" option enabled, there is probably a condition on their dialogue (like [size=2]Target.GetInFaction(CollegeofWinterholdFaction)=1) that you'll also need to remove.[/size]
  
* New interior cells in the College: add cells that don't have any Ownership (not including Midden) or have Ownership set to [size=2]CollegeCellsToAddOwnership but don't have a "Public Area" flag to CollegeCellsToAddOwnership formlist. There may be exceptions. Adding a cell to [size=2]CollegeCellsToAddOwnership [/size] dynamically sets [size=2]CollegeofWinterholdFaction[/size] as the cell owner and adds a "Public Area" flag. Without ownership you obviously will be able to take any items for free. If the cell has ownership but no "Public Area" flag, then visiting that cell will count as trespassing when you're not in the owner faction.[/size]
New objects in the College courtyard that can be taken: set ownership to CollegeofWinterholdFaction.
...
[Stuck in Saarthal - Use Any Spell to Escape](https://www.nexusmods.com/skyrimspecialedition/mods/64496)﻿ |[Increased Guild Fines](https://www.nexusmods.com/skyrimspecialedition/mods/52356)﻿ | [Aela Doesn't Approach If You Don't Help](https://www.nexusmods.com/skyrimspecialedition/mods/37800)﻿ | [and more](https://next.nexusmods.com/profile/lilebonymace/mods?gameId=1704)﻿