...
For SE 1.5.+ and AE 1.6.+. moreHUD 4.0.0.5Beta, 5.1.1.0, 5.2.2.0.
...
3. Configure moreHUD  mod in MCM.
  
4. Save settings (this version supports PapyrusUtil and FISS):
  
 A) **FISS**: Go to Presents->Save settings with FISS->Save User Settings.
  
 B) **PapyrusUtil**: Go to Presetns->Save setttings with PapyrusUtil->Save User Settings. Don't change settings name, it must be default.
  
5. Every new game will automatically load saved user settings. If you have FISS and PapyrusUtil settings saved mod will pick PapyrusUtil.
  
  
If you want to use this mod with existing save:
  
0. Disable moreHUD.
  
1. Save game.
  
2. Enable moreHUD and this mod.
  
  
You can try my [Custom HUD Presets](https://www.nexusmods.com/skyrimspecialedition/mods/55376) to see you they fit your taste :D
  
  
**FAQ:
  
  
I have CTD:**If you have CDT, it means that you have installed the universal version without having FISSES installed/active.
